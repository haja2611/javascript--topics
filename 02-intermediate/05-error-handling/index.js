...
function divide(a, b) {
    try {
        ...
        console.error("Caught an error:", error.message); // Access the error message
...
function validateUserData(userData) {
    try {
        if (!userData.username || userData.username.length < 3) {
            throw new CustomValidationError("Username must be at least 3 characters long.", "username");
        }
